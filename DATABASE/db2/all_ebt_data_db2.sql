...
--# ID Generation
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('BBS_ID',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('FILE_ID',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('GROUP_ID',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('LOGINLOG_ID',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('ROLE_ID',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('SAMPLE',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('SYSLOG_ID',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('TMPLAT_ID',1);
INSERT INTO HOMELIB.IDS(TABLE_NAME,NEXT_ID) VALUES ('USRCNFRM_ID',2);
--SELECT * FROM HOMELIB.IDS;


--# 분류코드
INSERT INTO HOMELIB.LETTCCMMNCLCODE(CL_CODE,CL_CODE_NM,CL_CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) VALUES ('LET','전자정부 프레임워크 경량환경 템플릿','전자정부 프레임워크 경량환경 템플릿1','Y','2011-08-02 21:13:03','SYSTEM','2011-08-09 17:17:08',null);
--SELECT * FROM HOMELIB.LETTCCMMNCLCODE;
...
--SELECT * FROM HOMELIB.LETTCCMMNCODE;
...
--SELECT * FROM HOMELIB.LETTNAUTHORGROUPINFO;
...
--SELECT * FROM HOMELIB.LETTNAUTHORINFO;
...
--SELECT * FROM HOMELIB.LETTNROLES_HIERARCHY;
...
--SELECT * FROM HOMELIB.LETTNROLEINFO;
...
--SELECT * FROM HOMELIB.LETTNAUTHORROLERELATE;
...
--SELECT * FROM HOMELIB.LETTNEMPLYRINFO;
...
--SELECT * FROM HOMELIB.LETTNEMPLYRSCRTYESTBS;
...
--SELECT * FROM HOMELIB.LETTNTMPLATINFO;
...
--SELECT * FROM HOMELIB.LETTNBBSMASTER;
...
--SELECT * FROM HOMELIB.LETTNBBSUSE;
...
--SELECT * FROM HOMELIB.LETTNPROGRMLIST;
...
--SELECT * FROM HOMELIB.LETTNMENUINFO;
