...
public class UserManageDAO extends EgovAbstractMapper{
     ...
     * @return String result 등록결과
     */
    public void insertOrgnztId(UserManageVO userManageVO){
        insert("userManageDAO.insertOrgnztId", userManageVO);
    }
     ...
     * @param passVO 업무사용자수정정보(비밀번호)
     */
    public void updatePasswordReset(UserManageVO passVO) {
        update("userManageDAO.updatePasswordReset_S", passVO);
    }
