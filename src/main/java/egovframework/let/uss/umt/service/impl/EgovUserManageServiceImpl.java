...
public class EgovUserManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserManageService {
	...
	public String insertUser(UserManageVO userManageVO) throws Exception {
		...
		try {
		    userManageDAO.insertUser(userManageVO); // 사용자 추가 로직
	...
	/**
	 * @param userManageVO 조직추가
	 * @return result 등록결과
	 * @throws Exception
	 */
	public void insertOrgnztId(UserManageVO userManageVO) throws Exception {
		
		userManageDAO.insertOrgnztId(userManageVO);
	 ...
	 */
	@Override
	public void updatePasswordReset(UserManageVO userManageVO) {
		userManageDAO.updatePasswordReset(userManageVO);
	}
