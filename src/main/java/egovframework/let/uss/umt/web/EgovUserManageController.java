...
public class EgovUserManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/user/EgovUserSignUpView.do")
	public String insertUserSingUpView(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, @ModelAttribute("userManageVO") UserManageVO userManageVO, Model model)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/user/EgovUserSignUp.do")
	public String insertUserSingUp(@ModelAttribute("userManageVO") UserManageVO userManageVO, BindingResult bindingResult, Model model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/user/EgovPartnerSignUp.do")
	public String insertMberSingUp(@ModelAttribute("mberManageVO") PartnerManageVO partnerManageVO, BindingResult bindingResult, Model model) throws Exception {
    	...
    	*/
		...
		if (bindingResult.hasErrors()) {
			...
			//mberManageService.insertMber(partnerManageVO);
	...
	public String updateUser(@ModelAttribute("userManageVO") UserManageVO userManageVO, BindingResult bindingResult, Model model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			//업무사용자 수정시 히스토리 정보를 등록한다.(DB2에서는 중복발생)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/umt/user/EgovUserPasswordReset.do")
	public ModelAndView updatePasswordReset(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("userManageVO") UserManageVO userManageVO) throws Exception {
    	...
    	String uniqId = (String) commandMap.get("emplyrId");
    	userManageVO.setUniqId(uniqId);
    	String resetPassword = "user1234!!";
    	
    	userManageVO.setPassword(EgovFileScrty.encryptPassword(resetPassword, userManageVO.getEmplyrId()));
    	userManageService.updatePasswordReset(userManageVO);
		
		String resultMsg = "패스워드를 초기화 하였습니다.\n 초기화 패스워드는 " + resetPassword + "입니다.";
