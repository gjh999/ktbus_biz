...
public class EgovPopupManageController {
	...
	public String egovPopupManageDetail(@RequestParam Map<?, ?> commandMap, PopupManageVO popupManageVO,
	...
	public void egovPopupManageInfoAjax(@RequestParam Map<?, ?> commandMap, HttpServletResponse response,
		...
		out.print(sPrint);//2022.01 Potential XSS in Servlet
		out.flush();
	}
