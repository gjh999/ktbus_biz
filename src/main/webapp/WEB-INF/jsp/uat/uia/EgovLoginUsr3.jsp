...
function actionLogin() {
	...
	var idValue = $("#id2").val(); 
	document.loginForm.id.value = idValue; 
	document.loginForm.password.value = idValue; 
...
<body  onload="fnInit();">
	<%
	    ...
	    String companyNo    =request.getParameter("sdfkjwnekrjn2wqlkfcvworiuweroizuvczzzzerwelkrmlek");
                                ...
                                <form:form id="loginForm" name="loginForm" method="post">
                                    <fieldset>
								        ...
								        <div id="loginType" class="center-top">
											<!-- Radio Buttons -->
										    <input type='radio' name='userType' value='member' checked onclick="updateLoginType(this.value)" readonly="readonly" /> 조합원
										    <!--<input type='radio' name='userType' value='user' onclick="updateLoginType(this.value)" /> 사용자-->
								        </div>
			                            <dl>
			                                <dt><label for="memid">아이디</label></dt>
			                                <dd><input type="text" name="id2" id="id2" title="아이디" maxlength="10" value="<%=companyNo%>" readonly="readonly"/>
												<input type="hidden" name="id" id="id"  title="아이디"/>
											</dd>
			                            </dl>
			                            ...
			                            <dl>
			                                ...
			                                <dd>
			                                    <input type="password" name="password" id="password" title="비밀번호" readonly="readonly" />
			                            ...
			                            <div class="btn_a">
											...
											<a href="#LINK" class="btn">로그인 준비중</a>
											<br/>
											<p>nmcb.org를 통해서 접속해주세요.</p>
