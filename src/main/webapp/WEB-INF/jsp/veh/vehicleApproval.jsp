...
<head>
	...
	<!-- ibsheet css -->
			...
			<script src="../../js/ibsheet/ibleaders.js"></script>
				...
				<script src='../../js/ibchart/highcharts.js'></script>
...
<!--	          <div class="content_wrap">-->
				<div id="contents" class="content" style="width:100%; padding-left:25px;">
	              <br>
	              <h1 class="tit_5">대폐차 업무 처리결과 <button class='btn btn_excel' onclick="excelDown()" type="button" style="float:right;">엑셀다운로드</a></button> 
		...
		<!--
			...
			'init':	{
			  ...
			  "Cfg": {
			    ...
			    //중앙(메인) 컬럼 설정
				"Cols": [
						{"Header": ["발급일자","발급일자"],"Name": "SEQN","Type": "Int","Width": 55, "Align":"Center"},
					  	{"Header": ["구분","구분"],"Name": "MBBUNH","Type": "Text","Format":"",MinWidth: 130, "Align":"Center"},
					  	{"Header": ["차량번호","차량번호"], "Name": "MKCHNO","Type": "Text","Format":"",Width: 145,RelWidth:1, "Align":"Center"},
						{"Header": ["말소","차명"],"Name": "MBBCNT","Type": "Text",Width:75 ,"Align":"Center"},
						{"Header": ["말소","연식"],"Name": "MBBNYMD","Type": "Text",Width: 100,"Align":"Center"},
						{"Header": ["말소","정원"],"Name": "MBBKUM","Type": "Int",Width: 90,RelWidth:1,},
					    {"Header": ["말소","차대번호"],"Name": "JIBUN","Type": "Text", Width : 80,RelWidth:1, "Align":"Center"},
					    {"Header": ["대차","차명"],"Name": "MBBSNO","Type": "Text", Width : 112,RelWidth:1, "Align":"Center"},
						{"Header": ["대차","연식"],"Name": "NAPBUN","Type": "Text", Width : 125,RelWidth:1,"Align":"Center"},
						{"Header": ["대차","정원"],"Name": "JNAPYMD","Type": "Text", Width : 110,RelWidth:1, "Align":"Center"},
						{"Header": ["대차","차대번호"],"Name": "CHADE","Type": "Text", Width : 110,RelWidth:1, "Align":"Center"},
						{"Header": ["등록여부","등록여부"],"Name": "DUNROCK","Type": "Text", Width : 110,RelWidth:1, "Align":"Center"}
					  ]
			},
			//시트 이벤트
			'event':{
			...
			'create':function () {
				var options = this.init;
					createIBChart("sheetDiv", "myChart", {
						width: "100%",
						height: "400px"
						});
						// !!! 차트 옵션 추가
			  ...
			  'doAction':function() {
			  			// !!! this.data를 차트에 데이터로 넣음
			  			// column chart 데이터 형태는 링크 참고 https://docs.ibsheet.com/ibchart/v1/manual/#docs/appx/chartData/columnData
			  			myChart.loadSearchData(this.data, {
			  				append: true
			  			});
			  		},
			//화면 기능
		...
		function doAction(str){			
			switch(str){
				case "search":
					...
					$('#FYM').val(tym);
					//데이터 조회
					sheet.doSearch({url: "<c:url value='/mss/veh/vehicleResult.do'/>", param: $("#listFrm").serialize()});
					break;
				case "exceldown":
				sheet.down2Excel({
					fileName: "TreeSheet",
