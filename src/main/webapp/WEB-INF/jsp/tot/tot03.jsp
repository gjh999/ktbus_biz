...
<!--	          <div class="content_wrap">-->
	            <div id="contents" class="content" style="width:100%; padding-left:25px;">
	              <br>
	              <h1 class="tit_5">사고일자별 접수  <button class='btn btn_excel' onclick="excelDown()" type="button" style="float:right;">엑셀다운로드</a></button></h1>
	...
	ib = {
		...
		'init': {
			...
			Def:{
							Row:{
								CanFormula:true,
								CalcOrder:"KUM9Format,OKUMFormat,CNT1Format,KUM1Format,CNT2Format,KUM2Format,CNT3Format,KUM3Format,CNT4Format,KUM4Format"
							}
						},
			//틀고정 좌측 컬럼 설정
			"LeftCols": [
				{"Header": "사고번호",	"Name": "C2BUNH","Type": "Text","Align": "center","FormulaRow": {"Value": "합계"}	},
				{"Header": "사고일시",	"Name": "C2SYMD","Type": "Date","Align": "center","Format": "yyyy-MM-dd HH:mm","FormulaRow": {"Value": "Count"}}
			],
			//중앙(메인) 컬럼 설정
			"Cols": [
					{"Header": "접수일시","Name": "C2JYMD","Type": "Date","Align": "center",MinWidth : 130,RelWidth: 1,"Format": "yyyy-MM-dd HH:mm"},
					{"Header": "차량번호","Name": "C2SCHNO","Type": "Text",MinWidth : 135,RelWidth: 1,"Align": "center"},
					{"Header": "운전자명","Name": "C2DNAM","Type": "Text",CustomFormat: "#*#",MinWidth : 80,RelWidth: 1,"Align": "center"},
					{"Header": "사고상태",	"Name": "C2STAT","Type": "Text",MinWidth : 90,RelWidth: 1,"Align": "center"},
					{"Header": "추산합계","Name": "KUM9","Type": "Int",MinWidth : 110,	RelWidth: 1,FormatFormula:"KUM9?'#,###':' '","FormulaRow": "Sum"},
					{"Header": "지급합계",	"Name": "OKUM","Type": "Int",MinWidth : 110,RelWidth: 1,FormatFormula:"OKUM?'#,###':' '","FormulaRow": "Sum"},
					{"Header": "대인인원",	"Name": "CNT1",MinWidth : 80,FormatFormula:"CNT1?'#,### 명':' '","Type": "Int"},
					{"Header": "대인추산",	"Name": "KUM1","Type": "Int",FormatFormula:"KUM1?'#,###':' '",MinWidth : 110,RelWidth: 1,"FormulaRow": "Sum"},
					{"Header": "대물건수",	"Name": "CNT2",MinWidth : 80,FormatFormula:"CNT2?'#,### 건':' '",	"Type": "Int"},
					{"Header": "대물추산",	"Name": "KUM2","Type": "Int",FormatFormula:"KUM2?'#,###':' '",MinWidth : 110,RelWidth: 1,"FormulaRow": "Sum"},
					{"Header": "자손인원",	"Name": "CNT3",MinWidth : 80,FormatFormula:"CNT3?'#,### 명':' '","Type": "Int"},
					{"Header": "자손추산","Name": "KUM3","Type": "Int",FormatFormula:"KUM3?'#,###':' '",	MinWidth : 110,RelWidth: 1,"FormulaRow": "Sum"},
					{"Header": "자차건수",	"Name": "CNT4",MinWidth : 80,FormatFormula:"CNT4?'#,### 건':' '","Type": "Int"},
					{"Header": "자차추산",	"Name": "KUM4","Type": "Int",FormatFormula:"KUM4?'#,###':' '",	MinWidth : 110,RelWidth: 1,"FormulaRow": "Sum"}
			]
		},
		//시트 이벤트
		'event': {
	...
	function doAction(str) {
		switch (str) {
			case "search":
				//데이터 조회
				sheet.doSearch({
					url: "<c:url value='/mss/tot/tot03List.do'/>",
					param: $(
							"#listFrm"
						)
						.serialize()
