...
<title>팝업창 상세보기</title><!-- 팝업창관리 상세보기 -->
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		if(!validatePopupManageVO(varFrom)){
			...
			if(iChkBeginDe > iChkEndDe || iChkEndDe < iChkBeginDe ){
				alert("게시시작일자는 게시종료일자 보다 클수 없고, 게시종료일자는 게시시작일자 보다 작을수 없습니다.");
				return;
			}
...
function fn_egov_delete_PopupManage(){
	...
	if(confirm('삭제 하시겠습니까?')){
		...
		varFrom.action = "<c:url value='/uss/ion/pwm/detailPopup.do' />";
		varFrom.submit();
	}else{
		varFrom.cmd.value = '';
	}
								...
								<div class="board_view2">
									...
									<table summary="팝업창 등록 양식입니다.">
										...
										<tr>
											...
											<td>
												<form:input id="ntceBgnde" class="f_txt center w_130 mr5" value="${fn:substring(popupManageVO.ntceBgnde, 0, 4)}-${fn:substring(popupManageVO.ntceBgnde, 4, 6)}-${fn:substring(popupManageVO.ntceBgnde, 6, 8)}" title="게시기간입력" path="ntceBgnde" maxlength="10" readonly="true"/>
												...
												&nbsp;~&nbsp;
												<form:input id="ntceEndde" class="f_txt center w_130 mr5" value="${fn:substring(popupManageVO.ntceEndde, 0, 4)}-${fn:substring(popupManageVO.ntceEndde, 4, 6)}-${fn:substring(popupManageVO.ntceEndde, 6, 8)}" title="게시기간입력" path="ntceEndde" maxlength="10" readonly="true"/>
									...
									<div class="board_view_bot">
	                                    ...
	                                    <div class="right_col btn1">
											<a href="#LINK" class="btn btn_red_46 w_100" onclick="javascript:fn_egov_delete_PopupManage(); return false;">삭제</a><!-- 삭제 -->
