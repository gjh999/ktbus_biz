...
<head>
	...
	<!-- SmartEditor2 라이브러리  -->
	<script type="text/javascript" src="/dist/smarteditor2/js/service/HuskyEZCreator.js" charset="utf-8"></script>
									...
									<%-- <div class="jsx-2303464893 editor">
										<div class="fr-box fr-basic fr-top" role="application">
											<div class="fr-wrapper show-placeholder" dir="auto">
												<textarea name="nttCn" id="nttCn" style="width: 100%; min-height: 412px;" readonly><c:out value="${result.nttCn}" escapeXml="false" /></textarea>
											</div>
										</div>
									</div> --%>
									<br>
