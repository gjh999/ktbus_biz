...
<script type="text/javascript">
    ...
    function fn_egov_regist_notice() {
        ...
        if( nttCn == ""  || nttCn == null || nttCn == '&nbsp;' || nttCn == '<br>' || nttCn == '<br />' || nttCn == '<p>&nbsp;</p>')  {
             alert("내용을 입력하세요.");
             return;
        }
                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
				                ...
				                <input type="hidden" name="smartEditorYn" value="Y" />
                                            ...
                                            <td colspan="2">
                                            	<div class="jsx-2303464893 editor">
													<div class="fr-box fr-basic fr-top" role="application">
														...
														<textarea id="nttCn" name="nttCn" class="f_txtar w_full h_400" cols="30" rows="10"></textarea>
