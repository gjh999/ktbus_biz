                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <input id="nttSj" class="f_txt w_full" name="nttSj" type="text" value="<c:out value="${result.nttSj}" escapeXml="false" />" maxlength="60" >
                                            ...
                                            <td colspan="2">
                                            	<div class="jsx-2303464893 editor">
													<div class="fr-box fr-basic fr-top" role="application">
														...
														<textarea id="nttCn" name="nttCn" class="f_txtar w_full h_400" cols="30" rows="10"><c:out value="${result.nttCn}" escapeXml="false" /></textarea>
