                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view2">
                                    <table summary="게시판명, 커뮤니티 동호회 정보 입니다">
                                        ...
                                        <tr>
                                            <td class="lb">
                                                <label for="trgetType">사용기관</label><!-- 조합명 -->
                                                <span class="req">필수</span>
                                            </td>
                                            <td>
                                                <label class="f_select" for="qestnrTrget">
                                                    <select name="trgetType" class="select" title="" onchange="fn_egov_selectTargetType(this)">
                                                        ...
                                                        <option value="SYSTEM" >조합1</option>
                                                        <option value="SYSTEM" >조합2</option>
                                                        <option value="SYSTEM" >조합3</option>
                                                        <option value="SYSTEM" >조합4</option>
                                                    </select>
                                                </label>
