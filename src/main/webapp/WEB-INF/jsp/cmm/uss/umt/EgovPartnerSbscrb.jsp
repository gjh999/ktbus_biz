                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <p class="txt_1">업무시스템의 사용자 등록을 요청합니다.</p>
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="javascript:document.mberManageVO.reset(); return false;">초기화</a><!-- 초기화 -->
                                    </div>
                                </div>
                                <!-- // 목록/저장버튼  끝-->
