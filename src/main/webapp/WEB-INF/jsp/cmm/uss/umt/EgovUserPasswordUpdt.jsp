...
function passwordReset(){
	...
	$.ajax({
		type:"POST",
	    url: "<c:url value='/uss/umt/user/EgovUserPasswordReset.do' />",
		dataType:'json',
		data: param,
                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view_bot">
                                    <div class="left_col btn3">
										...
										<c:if test="${sessionUniqId eq 'USRCNFRM_00000000000'}">
										<a href="#LINK" class="btn btn_skyblue_h46 w_100" onclick="javascript:passwordReset();">초기화</a><!-- 비번초기화 -->
										</c:if>
                                    </div>
