	...
	<script language="javascript1.2"  type="text/javaScript"> 
		...
		var jname=$("#JOHAP").val();
			...
			function excelDown(obj){
				...
				// OUTPUT 변수 생성
				   ...
				   // OUTPUT 조합: 총 22자리
				   var OUTPUT = jocode + fym + tym;
				   
				   // 출력 URL 생성
				   var printUrl = "https://biz.ktbus.com/MYSUIT/UView5/index.jsp?projectName=newmaa&formName=mrr5410&" + 
				   			               "JOCODE=" + jocode + "&" + 
				   			               "FYM=" + fym + "&" + 
				   			               "TYM=" + tym;
	    ...
	    'init': {
	        ...
	        "LeftCols": [
	            ...
	            {"Header": ["계약번호", "계약번호"],"Name": "MKBUN","Type": "Text","Width": 110,RelWidth: 1 },
	            {"Header": ["차량번호", "차량번호"],"Name": "MKCHNO","Type": "Text","Width": 150,RelWidth: 1,MinWidth:100}
	        ],
	        //중앙(메인) 컬럼 설정
	        "Cols": [
	            ...
	            {Header: ["상태", "상태"] ,Name: "CHK1" ,Type: "Text" ,MinWidth: 80 ,RelWidth: 1 ,Align: "center"},
	            {Header: ["갱신일자", "갱신일자"] ,Name: "SPBYMD" ,Type: "Date" ,Format: "yyyy-MM-dd" ,MinWidth: 100 ,RelWidth: 1 ,Align: "center"},
		...
		case "search":
		//데이터 조회
		sheet.doSearch({url: "<c:url value='/mss/maa/mrr5410List.do'/>", param: $("#listFrm").serialize()});
		break;
		case "action":
